      ...
      <Box bg="white" borderRadius="2xl" p={10} w="100%" maxW="420px" boxShadow="2xl">
        <VStack spacing={6} align="stretch">
          <Box>
            ...
            <Text color="gray.500" fontSize="sm">Sign in to your PriceTracker account</Text>
          </Box>
          ...
          <form onSubmit={handleSubmit}>
            <VStack spacing={4}>
              <FormControl isRequired>
                ...
                <Input value={username} onChange={e => setUsername(e.target.value)} autoFocus focusBorderColor="brand.500" />
              </FormControl>
              <FormControl isRequired>
                <FormLabel fontSize="sm">Password</FormLabel>
                <Input type="password" value={password} onChange={e => setPassword(e.target.value)} focusBorderColor="brand.500" />
              </FormControl>
              <Button type="submit" colorScheme="brand" width="100%" isLoading={loading} loadingText="Signing in...">
                Sign in
              </Button>
            </VStack>
          </form>
          <Text textAlign="center" fontSize="sm" color="gray.500">
            ...
            <Text as={Link} to="/register" color="brand.500" fontWeight={600}>Register</Text>
          </Text>
        </VStack>
      </Box>
    </Box>
