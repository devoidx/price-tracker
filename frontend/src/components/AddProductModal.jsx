  ...
  return (
    <Modal isOpen onClose={onClose} size="md">
      ...
      <ModalContent borderRadius="xl">
        <ModalHeader>Track a new product</ModalHeader>
        <form onSubmit={handleSubmit}>
          <ModalBody>
            <VStack spacing={4}>
              ...
              <FormControl isRequired>
                ...
                <Input placeholder="e.g. Sony WH-1000XM5" value={form.name} onChange={e => setForm({...form, name: e.target.value})} focusBorderColor="brand.500" autoFocus />
              </FormControl>
              <FormControl isRequired>
                <FormLabel fontSize="sm">URL</FormLabel>
                <Input placeholder="https://www.amazon.co.uk/dp/..." value={form.url} onChange={e => setForm({...form, url: e.target.value})} focusBorderColor="brand.500" />
              </FormControl>
              <FormControl>
                ...
                <FormHelperText>Optional — we'll try to detect automatically</FormHelperText>
              </FormControl>
              <FormControl>
          ...
          <ModalFooter gap={3}>
            ...
            <Button type="submit" colorScheme="brand" isLoading={loading} loadingText="Adding...">
              Start tracking
            </Button>
          </ModalFooter>
        </form>
